...
export default function OriginalPortfolio() {
  return <div className="legacy-portfolio"><SmoothScroll><Preloader /><Header /><ChapterRail /><Cursor /><Grain /><WorldColor /><main><Origin /><Craft /><Crossing /><Work /><Practice /><Invitation /></main></SmoothScroll></div>;
}
